...
local chairModels = {['models'] = {-1118419705, 1037469683, -109356459, -377849416, 589738836, -992710074},
                     ['offset'] = {0, -0.1, 0, 0, 0, 0.2}
}
...
RegisterNetEvent("dpemotes:eyeSit")
AddEventHandler("dpemotes:eyeSit", function(msg)
  local player = GetPlayerPed(-1)
  local coords = GetEntityCoords(player, true)
  local entity --GetEntityModel(entity)
  local aOffset 
  for i, e in pairs(chairModels.models) do 
    entity = GetClosestObjectOfType(coords.x,coords.y, coords.z, 1.0, e, false, false, false)
    if entity ~= 0 then
      aOffset = chairModels.offset[i]
      break
    end
  end
  if entity ~= 0 then
...
Citizen.CreateThread(function()
	local bank = {
		`prop_cs_office_chair`, `prop_off_chair_05`, `v_corp_offchair`, `v_ilev_leath_chr`, `v_corp_bk_chair3`, `v_med_cor_medstool`
	}
	exports["bt-target"]:AddTargetModel(bank, {
	
	options = {
	{
		event = "dpemotes:eyeSit",
		icon = "fas fa-chair",
		label = "Sit",
	},
	},
...
RegisterNetEvent('dpemote:walkBraveRadial')
AddEventHandler('dpemote:walkBraveRadial', function()
  WalkCommandStart2('brave')
end)

RegisterNetEvent('dpemote:walkDefaultRadial')
AddEventHandler('dpemote:walkDefaultRadial', function()
  WalkCommandStart2('reset')
end)

RegisterNetEvent('dpemote:walkHurryRadial')
AddEventHandler('dpemote:walkHurryRadial', function()
  WalkCommandStart2('hurry')
end)

RegisterNetEvent('dpemote:walkBusinessRadial')
AddEventHandler('dpemote:walkBusinessRadial', function()
  WalkCommandStart2('confident')
end)

RegisterNetEvent('dpemote:walkTipsyRadial')
AddEventHandler('dpemote:walkTipsyRadial', function()
  WalkCommandStart2('drunk')
end)

RegisterNetEvent('dpemote:walkInjuredRadial')
AddEventHandler('dpemote:walkInjuredRadial', function()
  WalkCommandStart2('slow')
end)

RegisterNetEvent('dpemote:walkToughRadial')
AddEventHandler('dpemote:walkToughRadial', function()
  WalkCommandStart2('tough')
end)

RegisterNetEvent('dpemote:walkSassyRadial')
AddEventHandler('dpemote:walkSassyRadial', function()
  WalkCommandStart2('sassy')
end)

RegisterNetEvent('dpemote:walkSadRadial')
AddEventHandler('dpemote:walkSadRadial', function()
  WalkCommandStart2('sad')
end)

RegisterNetEvent('dpemote:walkPoshRadial')
AddEventHandler('dpemote:walkPoshRadial', function()
  WalkCommandStart2('posh')
end)

RegisterNetEvent('dpemote:walkAlienRadial')
AddEventHandler('dpemote:walkAlienRadial', function()
  WalkCommandStart2('alien')
end)

RegisterNetEvent('dpemote:walkHoboRadial')
AddEventHandler('dpemote:walkHoboRadial', function()
  WalkCommandStart2('hobo')
end)

RegisterNetEvent('dpemote:walkMoneyRadial')
AddEventHandler('dpemote:walkMoneyRadial', function()
  WalkCommandStart2('money')
end)

RegisterNetEvent('dpemote:walkSwaggerRadial')
AddEventHandler('dpemote:walkSwaggerRadial', function()
  WalkCommandStart2('swagger')
end)

RegisterNetEvent('dpemote:walkShadyRadial')
AddEventHandler('dpemote:walkShadyRadial', function()
  WalkCommandStart2('shady')
end)

RegisterNetEvent('dpemote:walkManEaterRadial')
AddEventHandler('dpemote:walkManEaterRadial', function()
  WalkCommandStart2('maneater')
end)

RegisterNetEvent('dpemote:walkChiChiRadial')
AddEventHandler('dpemote:walkChiChiRadial', function()
  WalkCommandStart2('chichi')
end)

RegisterNetEvent('dpemotes:emoteRadial')
AddEventHandler('dpemotes:emoteRadial', function(e)
  print(e[1])
  OnEmotePlay(DP.Expressions[e[1]])
end)

RegisterNetEvent('dpemotes:emoteTrigger')
AddEventHandler('dpemotes:emoteTrigger', function(e)
  OnEmotePlay(DP.PropEmotes[e])
end)

RegisterNetEvent('dpemotes:emoteCancel')
AddEventHandler('dpemotes:emoteCancel', function()
  EmoteCancel()
end)

...
RegisterNetEvent('fanonx:client:illegalSell')
AddEventHandler('fanonx:client:illegalSell', function(name)
    if inZoneIllegal then
        exports["mf-inventory"]:openOtherInventory('illegal_Hide:1')
    end
end)
...
Citizen.CreateThread(function()
    ...
    exports["bt-target"]:AddTargetModel(peds, {
        options = {
            {
                event = "fanonx:client:illegalSell",
    ...
    exports["bt-polyzone"]:AddBoxZone("illegalHide", vector3(1996.02, 4982.71, 41.63), 4, 4, {
        name="illegalHide",
        heading=219.41,
        --debugPoly=true,
        minZ=40.0,

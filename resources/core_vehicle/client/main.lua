...
Citizen.CreateThread(
    function()
        ...
        TriggerServerEvent('esx_service:activateService', 'mosleys_mech', 20)
        job = ESX.GetPlayerData().job.name
        currentWear = Config.WearRate
    end
)

RegisterNetEvent("core_vehicle:clockIn")
AddEventHandler("core_vehicle:clockIn", function()
	local awaitService
	ESX.TriggerServerCallback('esx_service:isInService', function(isInService)
		if not isInService then
			...
			TriggerServerEvent('esx_service:disableService', 'mosleys_mech')
...
RegisterNetEvent("core_vehicle:openStorage")
AddEventHandler("core_vehicle:openStorage", function()
	exports["mf-inventory"]:openOtherInventory('mosleysStorage')
end)

Citizen.CreateThread(function()
	exports["bt-target"]:AddBoxZone("MosleyClockIn", vector3(-14.9211,-1662.419,29.4), 0.4, 0.6, {
		name="MosleyClockIn",
		heading=50,
		debugPoly=false,
		minZ=28.0,
    ...
    exports["bt-target"]:AddBoxZone("MosleyStorage", vector3(-8.92,-1658.65, 29.48), 1.5, 1.5, {
		name="MosleyStorage",
		heading=314,
		debugPoly=false,
		minZ=28.0,
		maxZ=31.0
			...
			options = {
				{
					event = "core_vehicle:openStorage",
                        ...
                        if IsControlJustReleased(0, Keys["E"]) and #(pedCoords - coords) < 2.0 then
                            ...
                            Citizen.CreateThread(
                                function()
                                    ...
                                    if repairInstall then
                                        exports['progressBars']:startUI(Config.EngineInstallTime, 'Installing Engine')
                                        Citizen.Wait(Config.EngineInstallTime)
                                    else
                                        exports['progressBars']:startUI(Config.EngineRepairTime, 'Repairing Engine')
                        ...
                        if IsControlJustReleased(0, Keys["E"]) and #(pedCoords - coords) < 2.0 then
                            ...
                            Citizen.CreateThread(
                                function()
                                    ...
                                    if repairInstall then
                                        exports['progressBars']:startUI(Config.TurboInstallTime, 'Installing Turbo')
                                        Citizen.Wait(Config.TurboInstallTime)
                                    else
                                        exports['progressBars']:startUI(Config.TurboRepairTime, 'Repairing Turbo')
                        ...
                        if IsControlJustReleased(0, Keys["E"]) and #(pedCoords - coords) < 2.0 then
                            ...
                            Citizen.CreateThread(
                                function()
                                    ...
                                    if repairInstall then
                                        exports['progressBars']:startUI(Config.NitroInstallTime, 'Instaling Nitro')
                                        Citizen.Wait(Config.NitroInstallTime)
                                    else
                                        exports['progressBars']:startUI(Config.NitroRepairTime, 'Repairing Nitro')
                        ...
                        if IsControlJustReleased(0, Keys["E"]) and #(pedCoords - coords) < 2.0 then
                            ...
                            Citizen.CreateThread(
                                function()
                                    ...
                                    if repairInstall then
                                        exports['progressBars']:startUI(Config.OilInstallTime, 'Changing Oil')
                                        Citizen.Wait(Config.OilInstallTime)
                                    else
                                        exports['progressBars']:startUI(Config.OilRepairTime, 'Changing Oil')
                        ...
                        if IsControlJustReleased(0, Keys["E"]) and #(pedCoords - coords) < 2.0 then
                            ...
                            Citizen.CreateThread(
                                function()
                                    ...
                                    if repairInstall then
                                        exports['progressBars']:startUI(Config.TransmitionInstallTime, 'Installing transmission')
                                        Citizen.Wait(Config.TransmitionInstallTime)
                                    else
                                        exports['progressBars']:startUI(Config.TransmitionRepairTime, 'Repairing transmission')
                    ...
                    if IsControlJustReleased(0, Keys["E"]) and #(pedCoords - wheel1) < 1.5 and w1 then
                        ...
                        Citizen.CreateThread(
                            function()
                                ...
                                if repairInstall then
                                    exports['progressBars']:startUI(Config.TireInstallTime, 'Swap tires')
                                    Citizen.Wait(Config.TireInstallTime)
                                else
                                    exports['progressBars']:startUI(Config.TireRepairTime, 'Swap tires')
                    ...
                    if IsControlJustReleased(0, Keys["E"]) and #(pedCoords - wheel1) < 1.5 and w1 then
                        ...
                        Citizen.CreateThread(
                            function()
                                ...
                                if repairInstall then
                                    exports['progressBars']:startUI(Config.BreaksInstallTime, 'Install brakes')
                                    Citizen.Wait(Config.BreaksInstallTime)
                                else
                                    exports['progressBars']:startUI(Config.BreaksRepairTime, 'Repair brakes')
                    ...
                    if IsControlJustReleased(0, Keys["E"]) and #(pedCoords - wheel1) < 1.5 and w1 then
                        ...
                        Citizen.CreateThread(
                            function()
                                ...
                                if repairInstall then
                                    exports['progressBars']:startUI(Config.SuspensionInstallTime, 'Install suspension')
                                    Citizen.Wait(Config.SuspensionInstallTime)
                                else
                                    exports['progressBars']:startUI(Config.SuspensionRepairTime, 'Repair suspension')

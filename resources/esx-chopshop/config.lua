...
Config.SellNPCName                      = "cs_josef"
Config.SellNPCLocation	                = { x = 2167.87, y = 3331.25, z = 46.47, h = 18.72 }
Config.SellNPCScenerioCurrent           = 'WORLD_HUMAN_LEANING'
Config.SellNPCScenerioInProg            = 'WORLD_HUMAN_LEANING'
...
Config.EnableKRPCoreIdentity            = false

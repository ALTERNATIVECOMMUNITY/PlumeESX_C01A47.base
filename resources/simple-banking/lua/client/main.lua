...
ATMObject = GetClosestObjectOfType(pos, 1.0, k, false)
...
RegisterNetEvent("Eye:atm")
AddEventHandler("Eye:atm", function(msg)
if (nearATM2() or nearBank() and not bMenuOpen) then
ToggleUI()
end
end)

...
Config.WeaponShops = {
    [1] = {
        name = "Ammunation Gun Store",
        blip = vector3(19.3055, -1111.714, 29.785),
    },
    [2] = {
        name = "Ammunation Gun Store",
        blip = vector3(811.5033, -2152.655, 29.61682),
    },
    [3] = {
        name = "Ammunation Gun Store",
        blip = vector3(842.9011, -1027.556, 28.184),
    },
    [4] = {
        name = "Ammunation Gun Store",
        blip = vector3(-662.769, -941.696, 21.815),
    },
    [5] = {
        name = "Ammunation Gun Store",
        blip = vector3(-1311.099, -391.806, 36.69),
    },
    [6] = {
        name = "Ammunation Gun Store",
        blip = vector3(247.2, -47.64396, 69.93848),
    },
    [7] = {
        name = "Ammunation Hunting Store",
        blip = vector3(-1114.404, 2694.224, 18.546),
    },
    [8] = {
        name = "Ammunation Gun Store",
        blip = vector3(1697.473, 3755.301, 34.688),
    },
    [9] = {
        name = "Ammunation Gun Store",
        blip = vector3(-326.8615, 6079.385, 31.45349),
    },
}
--ShopKeepers--
Config.Shopkeepers ={ --https://docs.fivem.net/docs/game-references/ped-models/ to see the models.
   ...
   [1] =  {
        model = `a_m_y_yoga_01`,
        CallCopsEarlyChance = 100,
        FightBackChance = 0,
        GiveSafeCodeChance = 100,
        ScaredChance = 50,

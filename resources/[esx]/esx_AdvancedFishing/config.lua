Config = {}
	...
	Config.FishPrice = {a = 750, b = 1000} --Will get clean money THIS PRICE IS FOR EVERY 5 FISH ITEMS (5 kg)
	Config.TurtlePrice = {a = 2500, b = 3000} --Will get dirty money
	Config.SharkPrice = {a = 4000, b = 5000} --Will get dirty money

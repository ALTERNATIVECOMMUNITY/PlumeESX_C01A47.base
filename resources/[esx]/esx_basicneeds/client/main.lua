...
RegisterNetEvent('esx_basicneeds:carryPlayerRadial')
AddEventHandler('esx_basicneeds:carryPlayerRadial', function()
local player, distance = GetClosestPlayer()
 ...
 if player~=-1 and distance < 2 then
	TriggerServerEvent('esx_basicneeds:sendCarry', GetPlayerServerId(player), GetPlayerPed(PlayerId()))
 end
end)

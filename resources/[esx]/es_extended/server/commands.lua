...
ESX.RegisterCommand('setjob', 'admin', function(xPlayer, args, showError)
	if ESX.DoesJobExist(args.job, args.grade) or args.job == 'mosleys_mech' or args.job == 'mount_zonah' or args.job == 'bennys' or args.job == 'towing' then
...
ESX.RegisterCommand('getjob', 'admin', function(xPlayer, args, showError)

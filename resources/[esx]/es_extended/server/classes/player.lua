function CreateExtendedPlayer(playerId, identifier, group, accounts, inventory, weight, job, loadout, name, coords)
	...
	self.removeMoney = function(money)
		...
		--TriggerClientEvent('okokNotify:Alert', -1, "Transaction", "You spent: "..money , Time, 'info')
	end
	  ...
	  if money > 0 then
		...
		if account then
		  ...
		  if not ignoreInventory then
			...
			--TriggerClientEvent('okokNotify:Alert', self.source, "Transaction", "You earned: $"..money , 6000, 'info')
		  else
			--TriggerClientEvent('okokNotify:Alert', self.source, "Transaction", "$"..money.." has been added your bank" , 6000, 'info')
		  end
		end
	  end
	end
	  ...
	  if money > 0 then
		...
		if account then
		  ...
		  if not ignoreInventory then
			...
			--TriggerClientEvent('okokNotify:Alert', self.source, "Transaction", "You spent: $"..money , 6000, 'info')
		  else
			--TriggerClientEvent('okokNotify:Alert', self.source, "Transaction", "$"..money.." has been withdrawn from your bank" , 6000, 'info')
		  end
		end
	  end
	end

...
RegisterCommand('livery', function(source, args, rawCommand)
	...
	if xPlayer.job.name == 'police' then
		TriggerClientEvent('esx_policejob:setLivery',source, args[1])
	end
end)
...
RegisterNetEvent('esx_policejob:getPlayerID')
AddEventHandler('esx_policejob:getPlayerID', function(target,dist, action)
	local identifier
	local distance = dist
	...
	if action == 'search' then 
		TriggerClientEvent('esx_policejob:OpenInventoryRadial', source, distance, identifier)
	elseif action == 'rob' then
		TriggerClientEvent('np-menu:robPlayer', source, distance, identifier)
	else
		TriggerClientEvent('esx_policejob:Frisk', source, distance, identifier)
	end
end)
...
RegisterNetEvent('esx_policejob:addImpound')
AddEventHandler('esx_policejob:addImpound', function(name, plate, loc)
	TriggerClientEvent('erp_towscript:addToList', -1, name, plate, loc)
end)

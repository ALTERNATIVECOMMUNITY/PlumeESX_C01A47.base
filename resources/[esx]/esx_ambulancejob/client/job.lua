...
RegisterNetEvent('esx_ambulancejob:healPlayerRadial')
AddEventHandler('esx_ambulancejob:healPlayerRadial', function()
	local closestPlayer, closestDistance = ESX.Game.GetClosestPlayer()
...
RegisterNetEvent('esx_ambulancejob:revivePlayerRadial')
AddEventHandler('esx_ambulancejob:revivePlayerRadial', function()
	local closestPlayer, closestDistance = ESX.Game.GetClosestPlayer()
	if closestDistance < 1.5 then
		revivePlayer(closestPlayer)
	end
...
RegisterNetEvent('esx_ambulancejob:putInVehicleRadial')
AddEventHandler('esx_ambulancejob:putInVehicleRadial', function()
	local closestPlayer, closestDistance = ESX.Game.GetClosestPlayer()
	TriggerServerEvent('esx_ambulancejob:putInVehicle', GetPlayerServerId(closestPlayer))
end)

RegisterNetEvent('esx_ambulancejob:OutVehicleRadial')
AddEventHandler('esx_ambulancejob:OutVehicleRadial', function()
	local closestPlayer, closestDistance = ESX.Game.GetClosestPlayer()
	print(closestPlayer)
...
AddEventHandler('esx_ambulancejob:OutVehicle', function(copId)
...
RegisterNetEvent('esx_ambulancejob:dragRadial')
AddEventHandler('esx_ambulancejob:dragRadial', function()
	local closestPlayer, closestDistance = ESX.Game.GetClosestPlayer()

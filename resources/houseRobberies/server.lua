...
local robbableItems = {
 ...
 [2] = {chance = 3, id = 'WEAPON_PISTOL', name = 'Pistol', quantity = 1}, -- rare --chance 10
 [3] = {chance = 5, id = 'weed_pooch', name = 'Bag of Weed', quantity = 1}, -- rare
 ...
 [8] = {chance = 3, id = 'sunglasses', name = 'Oakley Sunglasses (P)', quantity = 1}, -- rare
 [9] = {chance = 4, id = 'gameboy', name = 'Gameboy (P)', quantity = 1}, -- rare
 [10] = {chance = 3, id = 'casio_watch', name = 'Casio Watch (P)', quantity = 1}, -- rare
 [11] = {chance = 3, id = 'nokia_phone', name = 'Nokia Phone (P)', quantity = 1}, -- rare
 [12] = {chance = 5, id = 'samsung_s8', name = 'Samsung S8 (P)', quantity = 1}, -- rare
 [13] = {chance = 5, id = 'apple_iphone', name = 'Apple iPhone (P)', quantity = 1}, -- rare
 [14] = {chance = 4, id = 'steel', name = 'Steel', quantity = 1}, -- rare
 [15] = {chance = 4, id = 'screen', name = 'Screen', quantity = 1}, -- rare
 [16] = {chance = 5, id = 'scrap_metal', name = 'Scrap Metal', quantity = 1}, -- rare
 ...
 [20] = {chance = 7, id = 'fuse', name = 'Fuse', quantity = 1}, -- rare
 [21] = {chance = 8, id = 'clutch', name = 'Clutch', quantity = 1}, -- rare
 [22] = {chance = 5, id = 'battery', name = 'Battery', quantity = 1}, -- rare
 [23] = {chance = 2, id = 'breadboard', name = 'Breadboard (P)', quantity = 1}, -- rare
 [24] = {chance = 7, id = 'white_pearl', name = 'White Pearl (P)', quantity = 1}, -- rare
 [25] = {chance = 9, id = 'coke_pooch', name = 'Bag of Coke', quantity = 1}, -- rare
 [26] = {chance = 8, id = 'electronics', name = 'Electronics (P)', quantity = 1}, -- rare
 [27] = {chance = 9, id = 'electronic_kit', name = 'Electronic Kit', quantity = 1}, -- rare
}
...
print(source)
 for i=1, math.random(1, 2) do
  item = robbableItems[2]--robbableItems[math.random(1, #robbableItems)]
  print(item.name)
  if math.random(1, 10) >= item.chance then
   if tonumber(item.id) == 0 and not gotID[item.id] then
    ...
    TriggerClientEvent('houseRobberies:notify', source, 'You found $'..item.quantity)
  -- elseif item.isWeapon and not gotID[item.id] then
   -- gotID[item.id] = true
    ...
    --TriggerClientEvent('houseRobberies:notify', source, 'You found a '..item.name)
   elseif not gotID[item.id] then
    gotID[item.id] = true
    xPlayer.addInventoryItem(item.id, item.quantity)
    --TriggerClientEvent('chatMessage', source, 'You have found '..item.quantity..'x '..item.name)
    TriggerClientEvent('houseRobberies:notify', source, 'You have found '..item.quantity..'x '..item.name)
   end
  end
 end
end)
